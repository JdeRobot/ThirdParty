...
cp $WORK_DIR/Packaging/Linux/primesense-usb.rules $DESTDIR/etc/udev/rules.d/56-primesense-usb.rules
...
for LIB in `find $INSTALL_LIBS/OpenNI2/Drivers/ | grep so$`; do 
